...
import 'kyc1_dealer.dart';
class dealerverfication extends StatefulWidget {
  const dealerverfication({super.key});

  @override
  State<dealerverfication> createState() => _dealerverficationState();
}

class _dealerverficationState extends State<dealerverfication> {
  int activeStep = 0;
                          ...
                          InkWell(
                              onTap: () {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => dealerverfication1()));
                              },
                            child: Container(
                              height: 50,
                              width: 200,
