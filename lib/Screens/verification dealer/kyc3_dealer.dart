...
class dealerverfication3 extends StatefulWidget {
  const dealerverfication3({super.key});

  @override
  State<dealerverfication3> createState() => _dealerverfication3State();
}

class _dealerverfication3State extends State<dealerverfication3> {
  int activeStep = 3;
