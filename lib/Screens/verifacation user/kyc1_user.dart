...
import 'kyc2_user.dart';
class userverfication1 extends StatefulWidget {
  const userverfication1({super.key});

  @override
  State<userverfication1> createState() => _userverfication1State();
}

class _userverfication1State extends State<userverfication1> {
  int activeStep = 1;
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => userverfication2()));
                            },
                            child: Container(
                              height: 50,
                              width: 200,
