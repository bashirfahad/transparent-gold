...
import 'package:blumo_app/common_widgets/app_text.dart';
import 'package:blumo_app/helpers/column_with_seprator.dart';
...
class AccountScreen extends StatelessWidget {
          ...
          child: Column(
            children: [
              ...
              ListTile(
                ...
                subtitle: AppText(
                  text: "Founder of Transparent gold",
  ...
  Widget getImageHeader() {
    String imagePath = "assets/account_image.jpg";
    return CircleAvatar(
      radius: 5.0,
