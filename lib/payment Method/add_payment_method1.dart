...
import 'package:blumo_app/payment%20Method/add_payment_method.dart';
            ...
            body: Stack(
              children: [
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Image.asset("assets/payment/Credit Card.png",height: 250,width: 350,)
                          ],),
                        Padding(
                                ...
                                Row(
                                  children: [
                                    BankCategory(
                                      ...
                                      title: "PayPal",
                                      imagePath: "assets/payment/Paypal - White.png",
                                    ...
                                    BankCategory(
                                      ...
                                      title: "MasterCard",
                                      imagePath: "assets/payment/Mastercard - Normal.png",
                                    ...
                                    BankCategory(
                                      ...
                                      title: "Visa",
                                      imagePath: "assets/payment/Visa - Normal.png",
                ...
                Positioned(
                  ...
                  left: 10,
                  child: InkWell(
                    onTap: (){Navigator.pop(context, MaterialPageRoute(builder: (context)=>AddPaymentMethod()));},
                            ...
                            children: [
                              ...
                              Row(mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  RichText(
                                    text: TextSpan(children: [
                                      TextSpan(text: '   Payment method\n', style: GoogleFonts.lato(fontSize: 25,color: Colors.orangeAccent)),
                                      TextSpan(text: 'successfully', style: GoogleFonts.lato(fontSize: 25,fontWeight: FontWeight.w900,color: Colors.orange)),
                                      TextSpan(text: " Added!",style: GoogleFonts.poppins(fontSize: 25,color: Colors.orangeAccent))
                                    ]),)],
                              ),
                              SizedBox(height: 50,),
                              Row(mainAxisAlignment: MainAxisAlignment.center,
